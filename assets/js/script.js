...
// Dirubah 
const pengirim = "Syawal";
const nomorWa = "6285946053505" // awalan nomor 0 harus di awalin 62
const textWa = "Save"
const pesan = `Itu berarti kamu dan aku memang ditakdirkan untuk bersama selamanya. Jangan lupa untuk membalas pesan ini!`;
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    ...
    imageHeight: 120,
    title: 'Sebelum lanjut, Masukan dulu nama kamu',
    ...
    let txt = `Halo, Nama kamu ${result.value.login}, Nama kamu berawal dari huruf ${namaAwal.toUpperCase()}, ${namaAwal.toUpperCase()} untuk ${result.value.login} dan S untuk Syawal ${pesan}`;
